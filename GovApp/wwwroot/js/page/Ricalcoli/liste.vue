<template>
    <div>
        ...
        <b-skeleton-wrapper :loading="loading">
            ...
            <app-liste :elementi="listeview" :municipio="municipio" @next="caricaRicalcolo" :tipo="ricalcolo" @saver="saveRicalcolo"></app-liste>
        </b-skeleton-wrapper>
    ...
    export default {
        ...
        computed: {
            ...
            generaliview: function () {
                this.tipo = "Voti Lista " + this.municipio + " municipio";
                return this.votiRicalcolo.dati;
            }
        },       
        methods: {
            ...
            caricaRicalcolo(mun) { 
                ...
                this.ricalcolavoti({tipo: t, municipio: mun }).then(() => {
                   ...
                   //else {
                   //     if (this.VotiRicalcolo) {
                   //         this.voti = this.VotiRicalcolo;
                   //         this.listeview = this.voti;
                   //         this.generaliview = this.voti;
                   //     }
                   //     this.loading = false;
                   // }
                })
